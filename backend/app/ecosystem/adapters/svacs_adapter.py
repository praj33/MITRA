...
SVACS Adapter
-------------
Connects Mitra with SVACS (Veteran Affairs & Citizen Services platform).
Protocol: REST API.
"""
...
class SVACSAdapter(BaseBHIVAdapter):
    ...
    def _create_manifest(self) -> IntegrationManifest:
        return IntegrationManifest(
            ...
            base_url=os.getenv("SVACS_API_URL", "https://svacs.bhiv.example.com/api/v1"),
            capabilities=[
    ...
    async def query(self, request: IntegrationRequest) -> IntegrationResponse:
        ...
        try:
            ...
            headers = {
                "X-API-Key": os.getenv("SVACS_API_KEY", ""),
