...
TANTRA Adapter
--------------
Connects Mitra with TANTRA (Technical Architecture & Network Transmission platform).
...
class TANTRAAdapter(BaseBHIVAdapter):
    ...
    def _create_manifest(self) -> IntegrationManifest:
        return IntegrationManifest(
            ...
            base_url=os.getenv("TANTRA_API_URL", "https://tantra.bhiv.example.com/api/v1"),
            capabilities=[
    ...
    async def query(self, request: IntegrationRequest) -> IntegrationResponse:
        ...
        try:
            ...
            headers = {
                "X-API-Key": os.getenv("TANTRA_API_KEY", ""),
