...
Samruddhi Adapter
-----------------
Connects Mitra with Samruddhi (Economic Development & Welfare platform).
Protocol: REST API.
"""
...
class SamruddhiAdapter(BaseBHIVAdapter):
    ...
    def _create_manifest(self) -> IntegrationManifest:
        return IntegrationManifest(
            ...
            base_url=os.getenv("SAMRUDDHI_API_URL", "https://samruddhi.bhiv.example.com/api/v1"),
            capabilities=[
    ...
    async def query(self, request: IntegrationRequest) -> IntegrationResponse:
        ...
        try:
            ...
            headers = {
                "X-API-Key": os.getenv("SAMRUDDHI_API_KEY", ""),
