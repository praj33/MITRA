...
class PatternLibrary:
    ...
    HARD_DENY_PATTERNS = {
        ...
        RiskCategory.ILLEGAL_INTENT_PROBING: [
            ...
            (r'\bhurt(?:ing)? myself\b', 98, "Self-harm intent"),
            (r'\bdon\'t want to live\b', 99, "Death wish"),
            (r'\bgiving up on life\b', 97, "Life abandonment"),
            (r'\bharming myself\b', 98, "Self-harm"),
            (r'\bcompletely hopeless\b', 85, "Hopelessness"),
            (r'\bdisappear forever\b', 92, "Disappearance wish"),
            (r'\bcan\'t deal with life\b', 88, "Life crisis"),
            (r'\blife feels pointless\b', 90, "Existential crisis"),
            (r'\bthink about harming myself\b', 96, "Self-harm ideation"),
            
            # Hacking and illegal access
            (r'\bhack.*email\b', 95, "Email hacking"),
            (r'\bbreak into.*phone\b', 94, "Phone hacking"),
            (r'\bsteal money online\b', 96, "Online theft"),
            (r'\bbypass security systems?\b', 92, "Security bypass"),
            (r'\bbreak into.*account\b', 95, "Account hacking"),
            (r'\bcheat.*exam\b', 85, "Exam cheating"),
            (r'\bpirated software\b', 80, "Software piracy"),
            (r'\bbypass website security\b', 91, "Website bypass"),
            (r'\bcrack.*software\b', 88, "Software cracking"),
            (r'\bbreak into.*safe\b', 93, "Safe breaking"),
            
            # Manipulation instructions
            (r'\bhow.*emotionally manipulate\b', 95, "Manipulation instruction"),
            (r'\bmake.*feel guilty.*obey\b', 92, "Guilt manipulation instruction"),
            (r'\bcontrol.*decisions\b', 90, "Control instruction"),
            (r'\btrick.*trust\b', 88, "Trust manipulation"),
            (r'\bhow.*gaslight\b', 96, "Gaslighting instruction"),
            (r'\bpressure.*into.*want\b', 87, "Pressure instruction"),
            (r'\bmake.*dependent on me\b', 93, "Dependency creation"),
            (r'\bmanipulate.*friend\b', 89, "Friend manipulation"),
            (r'\bcontrol.*thoughts\b', 94, "Thought control"),
            (r'\bmake.*feel bad about themselves\b', 86, "Emotional harm instruction"),
            
            # Direct threats
            (r'\bI will hurt you\b', 98, "Direct threat"),
            (r'\byou better watch out\b', 85, "Warning threat"),
            (r'\bmake you regret\b', 92, "Regret threat"),
            (r'\bgoing to get hurt\b', 95, "Harm threat"),
            (r'\byou will pay\b', 93, "Revenge threat"),
            (r'\bI will destroy you\b', 97, "Destruction threat"),
            (r'\bgoing to regret crossing\b', 91, "Regret threat"),
            (r'\bI will find you\b', 96, "Stalking threat"),
            (r'\bbetter be careful\b', 80, "Warning threat"),
            (r'\bruin your life\b', 94, "Life destruction threat"),
            
            # Privacy violations
            (r'\bfind.*home address\b', 94, "Address seeking"),
            (r'\btrack.*phone location\b', 95, "Location tracking"),
            (r'\bspy on.*messages\b', 96, "Message spying"),
            (r'\baccess private emails\b', 95, "Email access"),
            (r'\bprivate photos\b', 93, "Photo access"),
            (r'\bget.*password\b', 96, "Password theft"),
            (r'\bmonitor.*phone\b', 95, "Phone monitoring"),
            (r'\bhack.*social media\b', 96, "Social media hacking"),
            (r'\bfind.*personal information\b', 88, "Info seeking"),
            (r'\bstalk.*online\b', 94, "Online stalking"),
