...
NYAI Adapter
------------
Connects Mitra with NYAI (National Youth AI & Innovation platform).
...
class NYAIAdapter(BaseBHIVAdapter):
    ...
    def _create_manifest(self) -> IntegrationManifest:
        return IntegrationManifest(
            ...
            base_url=os.getenv("NYAI_API_URL", "https://nyai.bhiv.example.com/api/v1"),
            capabilities=[
    ...
    async def query(self, request: IntegrationRequest) -> IntegrationResponse:
        ...
        try:
            ...
            headers = {
                "Authorization": f"Bearer {os.getenv('NYAI_API_KEY', '')}",
