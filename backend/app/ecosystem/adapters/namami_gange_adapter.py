"""
Namami Gange Adapter
--------------------
Connects Mitra with Namami Gange (River Conservation platform).
Protocol: REST API with event streaming.
"""
...
class NamamiGangeAdapter(BaseBHIVAdapter):
    ...
    def _create_manifest(self) -> IntegrationManifest:
        return IntegrationManifest(
            ...
            base_url=os.getenv("NAMAMI_GANGE_API_URL", "https://namamigange.bhiv.example.com/api/v1"),
            capabilities=[
    ...
    async def query(self, request: IntegrationRequest) -> IntegrationResponse:
        ...
        try:
            ...
            headers = {
                "X-API-Key": os.getenv("NAMAMI_GANGE_API_KEY", ""),
