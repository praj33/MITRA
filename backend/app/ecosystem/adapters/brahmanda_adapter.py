...
Brahmanda Adapter
-----------------
Connects Mitra with Brahmanda (Unified Data & Analytics platform).
...
class BrahmandaAdapter(BaseBHIVAdapter):
    ...
    def _create_manifest(self) -> IntegrationManifest:
        return IntegrationManifest(
            ...
            base_url=os.getenv("BRAHMANDA_API_URL", "https://brahmanda.bhiv.example.com/api/v1"),
            capabilities=[
    ...
    async def query(self, request: IntegrationRequest) -> IntegrationResponse:
        ...
        try:
            ...
            headers = {
                "X-API-Key": os.getenv("BRAHMANDA_API_KEY", ""),
