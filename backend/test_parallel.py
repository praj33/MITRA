import sys, io, urllib.request, json, time, concurrent.futures
...
tests = [
    ("TEST B", "Explain Python"),
    ("TEST C", "What is World?"),
    ("TEST D", "What is happening with AI today?"),
    ("TEST E", "https://www.thehindu.com/sport/")
]

print("Launching parallel tests B through E...", flush=True)
